...
# Latest Android Linux SDK for x64 and x86 as of 8-26-2015
ANDROID_SDK_X64="http://dl.google.com/android/android-sdk_r24.3.4-linux.tgz"
ANDROID_SDK_X86="http://dl.google.com/android/android-sdk_r24.3.4-linux.tgz"

# Latest NodeJS for x64 and x86 as of 8-26-2015
...
if [ "$LINUX_ARCH" == "x86_64" ]; then
    ...
    cd "$INSTALL_PATH" && mv "node-v0.12.7-linux-x64" "node"
    ...
    cd "$INSTALL_PATH" && mv "android-sdk-linux" "android-sdk"
    cd "$INSTALL_PATH" && mv "node-v0.12.7-linux-x86" "node"
